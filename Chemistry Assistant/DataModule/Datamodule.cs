...
namespace Chemistry_Assistant
{
    public partial class Datamodule : IDisposable
    {
        ...
        {
            //Es war im ältern Virsion So aber in neuen will die methode kein Steringreader die akzipter jetz nur sttring 
            ...
            try
            {
                //war früher so und weiß genau nicht was der macht aber hab script gelöscht und hat es funktionert 
                //FbBatchExecution batch = new FbBatchExecution(fbConnection, script);
                FbBatchExecution batch = new FbBatchExecution(fbConnection);

                // habe den appendsqlStatements gerufen um zu test ob fünktioner 
                // im Firebird clint 2.5.2.0 Wirde alles ist fbbatchexecution metode gemacht ich glaube in neue virsion würde eigen methode erstellt 
                //
                //
                //test
        ...
        public void ExecuteBatch(IList<string> sqlStatements, bool autoCommit)
        {
            ...
            try
            {
                ...
                foreach (string statement in sqlStatements)
                {
                    ...
                    // wird  Kommentiert weil weiß genau nicht was der macht 
